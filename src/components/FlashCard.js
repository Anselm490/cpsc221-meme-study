...
export default function FlashCard({ card, onClick, isCompleted }) {
  ...
  return (
    <div
      onClick={handleClick}
      className={`w-full max-w-md px-4 py-6 h-[calc(100vh-200px)] mx-auto shadow-xl rounded-2xl text-center text-lg cursor-pointer flex items-center justify-center transition
