...
export default function FlashCard({ card, onClick, isCompleted }) {
  ...
  return (
    <div
      onClick={handleClick}
      className={`mx-4 w-auto max-w-md h-[calc(100vh-200px)] p-6 mx-auto shadow-xl rounded-2xl text-center text-lg cursor-pointer flex items-center justify-center transition
